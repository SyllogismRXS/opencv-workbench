...
# Create test samples
perl ~/repos/opencv-workbench/scripts/createtestsamples.pl positives.dat negatives.dat tests 1000 "opencv_createsamples -bgcolor 0 -bgthresh 0 -maxxangle 1.1 -maxyangle 1.1 -maxzangle 0.5 maxidev 40"
