...
if [[ "$SWEEP_PARAM" != "static_threshold" && "$SWEEP_PARAM" != "ratio_threshold" && "$SWEEP_PARAM" != "gradient_threshold" && "$SWEEP_PARAM" != "min_velocity_threshold" && "$SWEEP_PARAM" != "max_velocity_threshold" && "$SWEEP_PARAM" != "covar_threshold" && "$SWEEP_PARAM" != "min_velocity_threshold_2" && "$SWEEP_PARAM" != "class_age_confirmed" && "$SWEEP_PARAM" != "max_leg_diff" && "$SWEEP_PARAM" != "min_relative_norm" ]]; then
