...
./scripts/learn-test-velocity.sh -y ./data/yaml-range-params/covariance-threshold.yaml -f ./data/scenarios/velocity-train-test.yaml -s min_relative_norm -h 1

#./scripts/learn-test-velocity.sh -y ./data/yaml-range-params/covariance-threshold.yaml -f ./data/scenarios/velocity-train-test.yaml -s max_leg_diff -h 1
